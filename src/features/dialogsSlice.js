...
// selectors
export const selectIsAddMovieDialogVisible = (state) => state.dialogs.isAddMovieDialogVisible;
export const selectIsEditMovieDialogVisible = (state) => state.dialogs.isEditMovieDialogVisible;
export const selectIsDeleteMovieDialogVisible = (state) => state.dialogs.isDeleteMovieDialogVisible;
